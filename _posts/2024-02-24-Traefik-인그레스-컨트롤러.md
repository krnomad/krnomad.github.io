...
tags: [ingress, traefik, k8s]
categories: [kubernetes]
description: "Traefik Ingress Controller를 설치하고 Dashboard, IngressRoute, TLS 테스트까지 연결하는 실습 기록입니다."
image:
  path: /assets/img/covers/traefik-ingress.svg
  alt: Traefik ingress controller setup cover
---
