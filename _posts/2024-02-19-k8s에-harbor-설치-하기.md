...
description: "Kubernetes 환경에 Harbor를 설치하고 레지스트리 구조, Helm 배포, Docker 연동까지 묶어 정리한 글입니다."
image:
  path: /assets/img/covers/harbor-install.svg
  alt: Harbor registry on Kubernetes cover
---
