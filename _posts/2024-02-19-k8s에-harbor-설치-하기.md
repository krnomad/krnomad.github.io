...
description: "**Harbor**는 **OCI 호환 클라우드 네이티브 아티팩트 레지스트리**로 진화했습니다. 이제 OCI 이미지와 OCI 이미지 인덱스를 지원합니다. OCI 이미지 인덱스는 하나 이상의 플랫폼을 위한 이미지 매니페스트 목록을 가리키는 더 높은 수준의 매니페스트입니다."
---
