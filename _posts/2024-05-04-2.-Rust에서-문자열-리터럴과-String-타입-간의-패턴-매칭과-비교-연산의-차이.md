...
tags: [rust, string]
categories: [rust]
description: "문자열 리터럴과 String이 패턴 매칭과 비교 연산에서 어떻게 다르게 동작하는지 예제로 정리한 글입니다."
image:
  path: /assets/img/covers/rust-string-match.svg
  alt: Rust string literal versus String cover
---
